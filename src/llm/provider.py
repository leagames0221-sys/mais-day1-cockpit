"""T3 LLMProvider Protocol (pluggable、 internal ADR § 4 inherit + T3 generative tasks 特化)。
...
Ollama に 1 file swap (provider 差替えのみ)。 ADR-201 軸 ② 「prompt code embedded」 設計反映
(CVE-2026-34070 不発)。
"""
...
class MockProvider:
    ...
    # ADR-205 Stage 2 LLM augmentation: false positive 排除 + reasoning。
