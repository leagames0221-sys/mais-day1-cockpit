"""NetworkX dependency graph + RiskScore 自動算出。

 5 dimension (security / continuity / culture / regulatory / financial) で 0-100 score、
 jp_day1_hits を literal 反映 (severity high → score boost、 axis に応じ dimension 配分)。
"""
...
# axis → 5 dimension impact weight
...
class CyclicDependencyError(Exception):
    """ systemPatterns 順守: blocks cycle 検出時 raise (NetworkX simple_cycles で literal detect)。"""
